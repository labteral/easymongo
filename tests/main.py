...
class MongoTest:
    def __init__(self):
        self.mongodb = MongodbConnector('localhost', 27017, connect=True)
        self.mongodb.set_defaults('test', 'test_collection')
...
test.check_existing_key()
test.check_existing_key_with_attributes()
